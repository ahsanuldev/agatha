...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="intro-caption relative z-10 bg-black/90 backdrop-blur-sm p-5 md:px-[60px] md:py-[50px] w-full max-w-[820px] ml-[5%] mr-[5%] md:mr-0 text-center sm:text-left shadow-2xl">
