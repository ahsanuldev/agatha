  ...
  return (
    <>
      ...
      <aside className="space-y-10">
        ...
        <div>
          <h3 className="text-xs uppercase tracking-wide2 text-gray-400 mb-4">Categories</h3>
        ...
        <div>
          <h3 className="text-xs uppercase tracking-wide2 text-gray-400 mb-4">Recent Posts</h3>
        ...
        <div>
          <h3 className="text-xs uppercase tracking-wide2 text-gray-400 mb-4">Popular Tags</h3>
        ...
        <div>
          <h3 className="text-xs uppercase tracking-wide2 text-gray-400 mb-4">Photo Stream</h3>
        ...
        <div>
          <h3 className="text-xs uppercase tracking-wide2 text-gray-400 mb-4">Subscribe</h3>
          <form
            onSubmit={(e) => e.preventDefault()}
            className="flex items-center border border-white/20"
          >
